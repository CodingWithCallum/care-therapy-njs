      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          <div className="flex-1 space-y-5">
            <h2 className="text-3xl font-bold text-gray-900">Our Specialist – Cameron</h2>
            <p>
              My name is Cameron Libera — a clinical and adaptive exercise specialist, and founder of CARE Therapy, offering mobile, individualized therapy in Pretoria and Johannesburg.
            </p>
            <p>
              I have over 3 years of international experience at the renowned <strong>Center of Achievement</strong> in California, working with clients experiencing stroke, MS, TBI, SCI, spina bifida, arthritis, CP, autism, and other conditions.
            </p>
          </div>
          <div className="flex-shrink-0 w-full max-w-xs md:max-w-sm lg:max-w-md">
            <Image
              src="/cameron_libera_linkedin.jpeg"
              width={600}
              height={600}
              alt="Portrait of Cameron Libera"
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-10 items-center">
          ...
          <div className="lg:w-1/2">
            <Image
              src="https://images.unsplash.com/photo-1717500252106-2a9f83cc61ed?q=80&w=1170&auto=format&fit=crop"
              width={1200}
              height={900}
              alt="Graduation cap symbolizing qualifications"
              className="rounded-lg object-cover w-full h-auto"
            />
          </div>
        </div>
