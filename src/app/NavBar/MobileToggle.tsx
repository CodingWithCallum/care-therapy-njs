  ...
  return (
    <div className="flex items-center justify-end relative z-60 lg:hidden">
      <button
        ...
        aria-expanded={open}
        className="p-3 rounded-full bg-emerald-600 outline-none w-12 aspect-square flex flex-col justify-center items-center"
      >
        ...
        />
        <span
          className={`w-6 mt-1 h-0.5 rounded-full bg-gray-300 transition-transform duration-300 ease-linear ${
            open ? "-translate-y-1.5 -rotate-45" : ""
          }`}
        />
      </button>
